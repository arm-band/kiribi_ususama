...
_.gulp.task('js.concat', () => {
    return _.gulp.src([`${dir.assets.jquery}/jquery.min.js`, `${dir.assets.bootstrap}/bootstrap.bundle.min.js`, `${dir.assets.easing}/jquery.easing.js`, `${dir.assets.bowser}/bundled.js`, `${dir.src.js}/_plugins/_plugins.js`])
        .pipe(_.plumber())
