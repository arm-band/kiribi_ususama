...
//js圧縮&結合&リネーム
const jsConcat = () => {
    let libSrcArray = [`${dir.assets.jquery}/jquery.min.js`, `${dir.assets.bootstrap}/bootstrap.bundle.min.js`, `${dir.assets.easing}/jquery.easing.js`, `${dir.assets.listjs}/list.js`];
    if(plugins.safari) {
...
module.exports = _.gulp.series(jsConcat, jsBuild);